...
public class CompleteProfileDetailAdapter extends RecyclerView.Adapter<CompleteProfileDetailAdapter.MyViewHolder> {
  ...
  public class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public CompleteProfileDetailAdapter(Context context, List<Event> friendEventList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.complete_occassion_row, parent, false);
